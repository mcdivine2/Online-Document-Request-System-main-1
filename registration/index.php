...
<div class="dashboard-wrapper">
    ...
    <div class="row">
                ...
                <h2 class="pageheader-title">
                    ...
                    <form id="validationform" name="student_form" data-parsley-validate="" novalidate="" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label text-sm-right"><i class="fa fa-user"></i>
                                Student Info</label>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input data-parsley-type="alphanum" id="latinTextBox1" type="text" name="middle_name"
                                    placeholder="" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input data-parsley-type="alphanum" id="latinTextBox2" type="text" name="last_name"
                                    required="" placeholder="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <textarea rows="1" data-parsley-type="alphanum" type="text" name="complete_address"
                                    required="" placeholder="" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Email Address</label>
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input data-parsley-type="alphanum" type="email" name="email_address" placeholder=""
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input data-parsley-type="alphanum" id="intTextBox" type="text" name="mobile_number"
                                    minlength="11" maxlength="11" required="" placeholder="" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input data-parsley-type="alphanum" type="file" alt="id_upload" id="id_upload"
                                    accept=".jpeg, .jpg, .png, .gif" required="" placeholder="" class="form-control">
                                <footer style="font-size: 11px"><b>File Type:</b>
                                    <font color="red"><i>.jpg .png .gif</i></font>
                                </footer>
                            </div>
                        </div>
                </div>
        ...
        <!--Admin form -->
        <!-- <div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12" id="adminForm" style="display: none;">
                <div class="card influencer-profile-data">
                    <div class="card-body">
                        <div class="" id="message"></div>
                        <form id="validationform" name="student_form" data-parsley-validate="" novalidate=""
                            ...
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Middle Name</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input data-parsley-type="alphanum" id="latinTextBox1" type="text"
                                        name="middle_name" placeholder="" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Last Name</label>
                            ...
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right"><i
                                        class="fa fa-user-lock"></i> Account Info</label>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Upload Picture/Id</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input data-parsley-type="alphanum" type="file" alt="id_upload" id="id_upload"
                                        accept=".jpeg, .jpg, .png, .gif" required="" placeholder=""
                                        class="form-control">
                                    <footer style="font-size: 11px"><b>File Type:</b>
                                        <font color="red"><i>.jpg .png .gif</i></font>
                                    </footer>
