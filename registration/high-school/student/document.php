                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                             <h2 class="pageheader-title"><i class="material-icons" style="font-size:36px" >add_a_photo</i> Add Screenshot </h2>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <?php 
                                                ...
                                                $studentHSID_no = $id['studentHSID_no'];

                                                
                                                $docu = $conn->fetchAll_HSdocument($studentHSID_no);
                                               ?>
