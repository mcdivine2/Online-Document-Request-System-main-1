                                    ...
                                    <div class="card influencer-profile-data">
                                        <div class="card-body" >
                                         ...
                                         <div class="col-6 offset-3">
                                          <div class="form-box" style="background-color:#1269AF !important">
                                           <div class="form-text">                                     
                                           ...
                                           <div class="form-text">
                                            <?php
                                                ...
                                                if ($row['status'] === 'Processing') {
                                                    echo 'It may take 2-3 days or more, it depends on the requested documents ';
                                                }
                                            ...
                                            <?php
                                             ...
                                             <div class="form-text">
                                               PRMSU Online Request of Documents System 2022
                                            </div>
