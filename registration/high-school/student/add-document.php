                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                             <h2 class="pageheader-title"><i class="fa-solid fa-camera"></i> Add Screenshot </h2>
                                            ...
                                            <form id="validationform" name="docu_form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" >
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        ...
                                                        <footer style="font-size: 11px"><b>Format:</b><font color="gray"> Name of Document - Students Name</font></footer>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row text-right">
                                                    <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                        ...
                                                        <input type="text" alt="studentHSID_no" value="
                                                        <?php $student_id = $_SESSION['student_id'];
                                                        
                                                        $conn = new class_model();
                                                        $id = $conn->get_studentHSno($student_id);


                                                         echo $id['studentHSID_no']
                                                        ?>
    ...
    (function() {
        ...
        window.addEventListener('load', function() {
           ...
           document.addEventListener('DOMContentLoaded', () => {
              ...
              const studentHSID_no = document.querySelector('input[alt=studentHSID_no]').value;

             var data = new FormData(this.form);

                data.append('document_name', $('#document_name')[0].files[0]);
                data.append('document_decription', document_decription);
                data.append('studentHSID_no', studentHSID_no);
