                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="docu_forms" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input data-parsley-type="alphanum"  name="studentHSID_no" value="<?= $getstudno['studentHSID_no']; ?>" type="text" required="" placeholder="" class="form-control" readonly>
                                                    </div>
                                                </div>
      ...
      <script>
          document.addEventListener('DOMContentLoaded', () => {
              ...
              btn.addEventListener('click', () => {
                  ...
                  const studentHSID_no = document.querySelector('input[name=studentHSID_no]').value;
              ...
              if (control_no === '' ||  studentHSID_no ==='' ||  email_address ==='' ||  document_name ==='' ||  no_ofcopies ===''||  date_request ===''){
