                                                    ...
                                                    <div class="col-xl-10 col-lg-8 col-md-8 col-sm-8 col-12">
                                                        <div class="user-avatar-info">
                                                            ...
                                                            <div class="user-avatar-address">
                                                                ...
                                                                <p class="border-bottom pb-3">
                                                                    <span class="d-xl-inline-block d-block mb-2"><i class="fa fa-certificate mr-2 text-primary "></i></span>
        ...
        window.addEventListener('load', function() {
          ...
          document.addEventListener('DOMContentLoaded', () => {
              ...
              btn.addEventListener('click', () => {
                  ...
                  const mobile_number = document.querySelector('input[name=mobile_number]').value;
              ...
              if (username === '' &&  password ==='' &&  phone_number ==='' &&  email_address ===''){
