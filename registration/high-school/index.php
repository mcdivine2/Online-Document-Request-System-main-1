...
<nav class="navbar navbar-dark bg-primary" style="background: rgb(17,10,134);
  ...
  <span class="navbar-brand mb-0 h1">High School Student</span>
</nav>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="dropdown-menu container-fluid" aria-labelledby="dropdownMenuLink" >
                        ...
                        <a class="dropdown-item container-fluid" href="http://localhost/ORDS/college/">Collge</a>
                    ...
                    <div class="form-group">
                        <label class="custom-control custom-checkbox">
                            ...
                            <a href="http://localhost/ORDS/registration-hs/index.php" class="register">Register</a>
                        </label>
                    </div>
                   <div class="form-group">
