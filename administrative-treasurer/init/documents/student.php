            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                             <h2 class="pageheader-title"><i class="fa fa-fw fa-user-graduate"></i> Clients </h2>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Clients Information</h5>
                                <div class="card-body">
                                     <div id="message"></div>
                                                    ...
                                                    <td>
                                                     <?php 
                                                      if($row['account_status'] === 'Active'){
                                                         ...
                                                         echo '<span class="badge bg-danger text-white">Deactivate</span>';
                                                       }
                                                      ?>
                                                    </td>
