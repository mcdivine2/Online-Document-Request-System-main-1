    ...
    <div class="splash-container" style="margin-top: 30px">
        <div class="card ">
            <div class="card-header text-center"><a href="index.html"><img class="scc_logo"
                        src="assets/images/scc_logo.png" alt="prmsu_logo" height="200px"></a></div>
            <div class="card-body">
                <form method="post" name="login_form">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="username" alt="username" type="text"
                            placeholder="Username" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="password" type="password" alt="password"
                    ...
                    <div class="form-group">
                      ...
                      color: rgb(243, 245, 238) !important;" value="Sign in" id="btn-login" name="btn-login">Sign
                            in</button>
                    </div>
