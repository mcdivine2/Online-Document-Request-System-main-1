                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Waiting for Payment</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                               ...
                                               <?php foreach ($docrequest as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-right">
                                                        ...
                                                        <a href="email-form-wfp.php?request=<?= $row['request_id']; ?>&student-number=<?php echo $row['studentID_no']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
