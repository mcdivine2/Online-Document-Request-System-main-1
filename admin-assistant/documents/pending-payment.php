                                               ...
                                               <?php foreach ($docrequest as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-right">
                                                        ...
                                                        <a href="email-form-p.php?request=<?= $row['request_id']; ?>&student-number=<?php echo $row['studentID_no']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
