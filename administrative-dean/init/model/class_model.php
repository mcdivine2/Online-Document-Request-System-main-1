	...
	class class_model{
	    ...
	    public function fetchAll_documentrequest(){ 
		  ...
		  public function fetchAll_newrequest(){ 
            $sql = "SELECT * FROM  tbl_documentrequest WHERE dean_status = 'Received' ";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		  ...
		  public function fetchAll_releasing(){ 
            $sql = "SELECT * FROM  tbl_documentrequest WHERE dean_status = 'Releasing' ";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		  ...
		  public function fetchAll_released(){ 
            $sql = "SELECT * FROM  tbl_documentrequest WHERE dean_status = 'Released' ";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		  ...
		  public function fetchAll_pendingpayment(){ 
            $sql = "SELECT * FROM  tbl_documentrequest WHERE dean_status = 'Waiting for Payment'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		...
		public function edit_request($control_no, $student_id, $document_name, $no_ofcopies, $date_request, $date_releasing, $dean_status, $request_id){
			$sql = "UPDATE `tbl_documentrequest` SET  `control_no` = ?, `student_id` = ?, `document_name` = ?, `no_ofcopies` = ?, `date_request` = ?, `date_releasing` = ?, `dean_status` = ?  WHERE request_id = ?";
			 $stmt = $this->conn->prepare($sql);
			$stmt->bind_param("sssssssi", $control_no, $student_id, $document_name, $no_ofcopies, $date_request, $date_releasing, $dean_status, $request_id);
			if($stmt->execute()){
				$stmt->close();
				$this->conn->close();
				return true;
	   ...
	   public function delete_user($user_id){
	    ...
	    public function count_numberoftotalrequest(){ 
		 ...
		 public function count_numberoftotalpending(){ 
            $sql = "SELECT COUNT(request_id) as count_pending FROM tbl_documentrequest WHERE dean_status = 'Waiting for Payment'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		   ...
		   public function count_numberoftotalpaid(){ 
            $sql = "SELECT COUNT(request_id) as count_paid FROM tbl_documentrequest WHERE dean_status = 'Paid'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		 ...
		 public function count_numberoftotalreceived(){ 
            $sql = "SELECT COUNT(request_id) as count_received FROM tbl_documentrequest WHERE dean_status = 'Received'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		  ...
		  public function count_numberofreleased(){ 
            $sql = "SELECT COUNT(request_id) as count_released FROM tbl_documentrequest WHERE dean_status = 'Releasing'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		  ...
		  public function count_released(){ 
            $sql = "SELECT COUNT(request_id) as count_released FROM tbl_documentrequest WHERE dean_status = 'Released'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
