	...
	class class_model{
	    ...
	    public function fetchAll_documentrequest(){ 
		  ...
		  public function fetchAll_declined(){ 
            $sql = "SELECT * FROM  tbl_documentrequest WHERE dean_status = 'Declined'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		  ...
		  public function fetchAll_verified(){ 
            $sql = "SELECT * FROM  tbl_documentrequest WHERE dean_status = 'Verified'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
	    ...
	    public function count_numberoftotalrequest(){ 
		 ...
		 public function count_numberoftotalreceived(){ 
		  ...
		  public function count_declined(){ 
            $sql = "SELECT COUNT(request_id) as count_declined FROM tbl_documentrequest WHERE dean_status = 'Declined'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
		  ...
		  public function count_verified(){ 
            $sql = "SELECT COUNT(request_id) as count_verified FROM tbl_documentrequest WHERE dean_status = 'Verified'";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
