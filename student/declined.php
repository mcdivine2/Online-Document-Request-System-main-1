                                    ...
                                    foreach ($docrequest as $row) { ?>
                                        <tr>
                                            ...
                                            <td class="align-right">
                                                <div class="box">
                                                    <div class="four">
                                                        <a href="Track-document.php?request=<?= $row['request_id']; ?>&student-number=<?= $row['student_id']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="View Request">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </div> 
                                                </div>
