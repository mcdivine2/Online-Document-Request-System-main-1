        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="request-list.php"><i class="fa fa-fw fa-file"></i>History Request <span class="badge badge-success">6</span></a>
                    </li>
                    <li class="nav-item ">
                            <a class="nav-link" href="document.php"><i class="fa fa-fw fa-file-image"></i>Send Proof of Payment <span class="badge badge-success">6</span></a>
                        </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="add-request.php"><i class="fa fa-fw fa-plus"></i>Request Document <span class="badge badge-success">6</span></a>
