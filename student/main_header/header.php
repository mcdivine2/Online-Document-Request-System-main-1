...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Diplomata+SC&family=Yanone+Kaffeesatz&display=swap');
    </style>
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg fixed-top" id="head-color">
                <a class="navbar-brand" href="index.php">
                    <p id="title-style"><img class="logo-scc" src="../asset/images/scc_logo.png" alt="logo" width="70px" height="50px">&nbsp;&nbsp;e-Docs-Columbano</p>
                </a>
