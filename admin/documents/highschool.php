            ...
            <div class="container-fluid  dashboard-content">
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Student Information - Highschool</h5>
                                <div class="card-body">
                                     <div id="message"></div>
                                    <div class="table-responsive">
                                        <a href="add-student.php" class="btn btn-sm" style="background-color:#1269AF !important; color:white"><i class="fa fa-fw fa-user-plus"></i> Add Highschool Student</a><br><br>
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                             <?php 
                                                ...
                                                $student = $conn->fetchAll_hsstudent();
                                               ?>
                                               <?php foreach ($student as $row) { ?>
                                                <tr>
                                                    <td><?= $row['studentHSID_no']; ?></td>
