                                              ...
                                              ?>
                                               <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6"> 
                                                       <select data-parsley-type="alphanum" type="text" value="<?= $row['library_status']; ?>" id="library_status" required="" placeholder="" class="form-control">
      ...
      <script>
          document.addEventListener('DOMContentLoaded', () => {
              ...
              btn.addEventListener('click', () => {
                  ...
                  const library_status = $('#library_status option:selected').val();
                  ...
                  data.append('library_status', library_status);
                  data.append('request_id', request_id);


              if (control_no === '' &&  student_id ==='' &&  document_name ==='' &&  date_request ===''  &&  processing_officer ==='' &&  library_status ==='' &&  request_id ===''){
